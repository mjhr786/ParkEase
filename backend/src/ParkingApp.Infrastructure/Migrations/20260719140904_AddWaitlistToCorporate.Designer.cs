...
namespace ParkingApp.Infrastructure.Migrations
{
    ...
    [Migration("20260719140904_AddWaitlistToCorporate")]
    partial class AddWaitlistToCorporate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkingApp.Marketplace.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("ParkingApp.Identity.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ParkingApp.Messaging.Domain.Entities.Conversation", b =>
                {
                    b.HasOne("ParkingApp.Marketplace.Domain.Entities.ParkingSpace", null)
                        .WithMany()
                        .HasForeignKey("ParkingSpaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
