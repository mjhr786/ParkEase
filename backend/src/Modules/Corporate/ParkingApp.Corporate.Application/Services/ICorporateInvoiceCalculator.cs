...
/// </summary>
internal interface ICorporateInvoiceCalculator
{
...
internal sealed class CorporateInvoiceCalculator : ICorporateInvoiceCalculator
{
        ...
        IReadOnlyList<InvoiceAllocationChargeInput> allocations)
    {
        ...
        foreach (var allocation in allocations)
        {
            ...
            var description = $"Reserved capacity ΓÇö {title}{leaseBit} ┬╖ {overlapDays}d";
        ...
        IReadOnlyList<InvoiceBookingChargeInput> bookings)
    {
        ...
        foreach (var booking in bookings)
        {
            ...
            var description =
                $"Usage ΓÇö {who} ┬╖ {space} ┬╖ {booking.StartDateTime:yyyy-MM-dd}";
