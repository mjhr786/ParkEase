...
internal sealed class WaitlistAutoPromotionOptions
{
    ...
    /// <summary>Seconds between polls. Free-tier default favors fewer DB opens (was 30).</summary>
...
/// with backoff G�� they should not look like hard process failures.
/// </summary>
internal sealed class WaitlistAutoPromotionBackgroundService : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            {
                // 15s, 30s, 60sGǪ capped at 5 minutes G�� avoid hammering a flaky link.
