...
internal sealed class OSRMService : IRoutingService
{
    ...
    public List<(double Distance, int Duration)> GetBatchHaversine(
        double startLat,
        double startLng,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Same baseline as GetBatchHaversine — OSRM only upgrades road distance when successful.
        var results = GetBatchHaversine(startLat, startLng, destinations);
