...
internal class MarketplaceRepository<T> : IRepository<T> where T : BaseEntity
{
    ...
    // AnyAsync and CountAsync are pure predicates — no entity materialisation, but AsNoTracking
    // avoids the EF internal snapshot machinery for the query plan cache.
