...
/// </summary>
internal sealed class ParkingSpaceCreatedCacheHandler : IDomainEventHandler<ParkingSpaceCreatedEvent>
{
...
internal sealed class ParkingSpaceUpdatedCacheHandler : IDomainEventHandler<ParkingSpaceUpdatedEvent>
{
    private readonly ICacheService _cache;
...
internal sealed class ParkingSpaceDeletedCacheHandler : IDomainEventHandler<ParkingSpaceDeletedEvent>
{
    private readonly ICacheService _cache;
...
internal sealed class ParkingSpaceToggledCacheHandler : IDomainEventHandler<ParkingSpaceToggledEvent>
{
    private readonly ICacheService _cache;
