...
namespace ParkingApp.Marketplace.Application.Queries.Dashboard;
...
internal sealed class GetVendorDashboardHandler : IQueryHandler<GetVendorDashboardQuery, ApiResponse<VendorDashboardDto>>
{
...
internal sealed class GetMemberDashboardHandler : IQueryHandler<GetMemberDashboardQuery, ApiResponse<MemberDashboardDto>>
{
    private readonly IDashboardRepository _repository;
    private readonly ICacheService _cache;
