...
/// <summary>
/// EF-backed generic repository for Messaging aggregates (BuildingBlocks base types).
/// </summary>
internal class MessagingRepository<T> : IRepository<T> where T : BaseEntity
{
    protected readonly DbContext _context;
    protected readonly DbSet<T> _dbSet;

    public MessagingRepository(DbContext context)
    {
        _context = context;
