...
namespace ParkingApp.Identity.Application.Commands.Vehicles;
...
internal class CreateVehicleCommandHandler : ICommandHandler<CreateVehicleCommand, ApiResponse<VehicleDto>>
{
    private readonly IIdentityUnitOfWork _unitOfWork;

    public CreateVehicleCommandHandler(IIdentityUnitOfWork unitOfWork)
    {
...
internal class UpdateVehicleCommandHandler : ICommandHandler<UpdateVehicleCommand, ApiResponse<VehicleDto>>
{
    private readonly IIdentityUnitOfWork _unitOfWork;

    public UpdateVehicleCommandHandler(IIdentityUnitOfWork unitOfWork)
    {
        _unitOfWork = unitOfWork;
    }
...
internal class DeleteVehicleCommandHandler : ICommandHandler<DeleteVehicleCommand, ApiResponse<bool>>
{
    private readonly IIdentityUnitOfWork _unitOfWork;

    public DeleteVehicleCommandHandler(IIdentityUnitOfWork unitOfWork)
    {
        _unitOfWork = unitOfWork;
    }
