...
public class BookingRepositoryTests
{
    ...
    {
        var owner = new User { Id = Guid.NewGuid(), Email = "owner@t.com", PasswordHash = "h", FirstName = "F", LastName = "L", PhoneNumber = "P" };
        var user = new User { Id = Guid.NewGuid(), Email = "user@t.com", PasswordHash = "h", FirstName = "F", LastName = "L", PhoneNumber = "P" };
    ...
    public async Task GetByIdWithDetailsAsync_IncludesRelations()
    {
        ...
        result.ParkingSpace.OwnerId.Should().Be(space.OwnerId);
    }
