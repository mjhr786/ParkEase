...
public class UnitOfWorkTests
{
    ...
    public UnitOfWorkTests()
    {
        ...
        _processorMock
            .Setup(p => p.ProcessByIdsAsync(It.IsAny<IReadOnlyList<Guid>>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(0);
    ...
    public async Task SaveChangesAsync_EnqueuesDomainEventsToOutbox_AndProcesses()
    {
        ...
        _processorMock.Verify(
            p => p.ProcessByIdsAsync(It.IsAny<IReadOnlyList<Guid>>(), It.IsAny<CancellationToken>()),
            Times.Once);
    }
