...
public class PaymentRepositoryTests
{
    ...
    public async Task GetByBookingIdAsync_ReturnsPayment()
    {
        ...
        var payment = new Payment { Id = Guid.NewGuid(), BookingId = booking.Id, UserId = user.Id, Amount = 10, Currency = "USD", Status = ParkingApp.Marketplace.Contracts.Enums.PaymentStatus.Completed };
